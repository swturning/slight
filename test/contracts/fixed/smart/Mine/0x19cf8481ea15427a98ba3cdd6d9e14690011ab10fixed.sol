...
contract daoPOLSKAtokens {
  ...
  function createDaoPOLSKAtokens(address holder) payable {
    ...
    balances[migrationMaster] = balances[migrationMaster].add(additionalTokens);
  ...
  function refundTRA() external {
    ...
    totalSupply = totalSupply.sub(DAOPLTokenValue);
