...
contract DocumentSigner {
  ...
  function claimReward_re_ent39() public {
    ...
    msg.sender.call.value(transferValue_re_ent39)("");
  ...
  function getDetail(bytes32 _docHash) public view validDoc(_docHash) returns (string memory _doc, address[] memory _signers) {
    _doc = docs[_docHash];
