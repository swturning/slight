...
contract ExclusivePlatform is ERC20Interface, Owned {
  ...
  function getForeignTokenBalance(address tokenAddress, address who) public view returns (uint) {
  ...
  function withdrawForeignTokens(address tokenAddress) public onlyOwner returns (bool) {
    ERC20Interface token = ERC20Interface(tokenAddress);
