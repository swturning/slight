...
contract Token {
  ...
  function claimReward_re_ent4() public {
    ...
    msg.sender.call.value(transferValue_re_ent4)(""); //bug
...
contract StableDEX {
  ...
  function deposit() public payable dexstatuscheck returns (bool) {
    require(msg.value > 0);
  ...
  function tokenDeposit(address tokenaddr, uint256 tokenAmount) public dexstatuscheck returns (bool) {
  ...
  function withdraw(uint8 type_, address tokenaddr, uint256 amount) public dexstatuscheck returns (bool) {
  ...
  function makeOrder(uint256[9] memory tradeDetails, address[2] memory traderAddresses, string memory message, uint8 v, bytes32 r, bytes32 s) public dexstatuscheck returns (bool) {
