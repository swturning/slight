...
contract PHO is IERC20 {
  ...
  function transfer(address to, uint256 value) public returns (bool success) {
    ...
    if (msg.sender == team) {
      ...
      if (balances[msg.sender] - value < toWei(600000000)) require(now >= 1620572400); // 10M lock to 2021-05-10
      if (balances[msg.sender] - value < toWei(400000000)) require(now >= 1652108400); // 10M lock to 2022-05-10
      if (balances[msg.sender] - value < toWei(200000000)) require(now >= 1683644400); // 10M lock to 2023-05-10
    }
