...
public interface SolidityVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link SolidityParser#newConrtact}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitNewConrtact(SolidityParser.NewConrtactContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link SolidityParser#typeExpression}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitTypeExpression(SolidityParser.TypeExpressionContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link SolidityParser#arrayRange}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitArrayRange(SolidityParser.ArrayRangeContext ctx);
	/**
	 * Visit a parse tree produced by {@link SolidityParser#newDynamicArray}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitNewDynamicArray(SolidityParser.NewDynamicArrayContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link SolidityParser#varDeclaration}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitVarDeclaration(SolidityParser.VarDeclarationContext ctx);
	/**
